...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative lg:h-screen scroll-mt-24 flex flex-col bg-primary text-neutral-white"
    >
      {/* ── Top: two-column layout ───────────────────────── */}
      <div className="flex flex-col lg:flex-row flex-grow overflow-hidden">
        {/* Left 60 % */}
        <motion.div
          className="lg:w-[60%] w-full flex flex-col justify-center items-center bg-primary relative px-6 py-5 pb-0"
        ...
        >
          ...
          <div className="z-10 w-full flex flex-col items-center">
            <div className="text-neutral-white text-md md:text-2xl font-bold leading-relaxed space-y-2 text-center">
              <p>PSG COLLEGE OF TECHNOLOGY</p>
              <p>COMPUTER APPLICATIONS ASSOCIATION</p>
              <p className="text-gradient text-sm md:text-lg">Proudly Present</p>
            </div>
        ...
        <motion.div
          className="
            lg:w-[40%] w-full lg:bg-primary
            flex flex-col justify-center items-center
            relative px-6 py-5 pb-0
          "
          initial={{ opacity: 0, x: 60 }}
          animate={{ opacity: 1,  x: 0 }}
          transition={{ duration: 0.8 }}
        >
          ...
          <div className="z-10 text-center">
            ...
            <h2 className="text-xl font-bold text-gradient-1 mb-4">Countdown&nbsp;Begins</h2>
